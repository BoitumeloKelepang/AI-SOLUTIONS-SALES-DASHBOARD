...
target_revenue_by_year = {
    2022: random.randint(500000, 99999),  # Reduced to 5-7 digits, profitable
    2023: 100000,  # Loss year
    2024: 200000,  # Underperforming year
    2025: random.randint(500000, 99999)   # Reduced to 5-7 digits, profitable
}
target_sales_volume_by_year = {
    2022: 10000,  # Very low sales volume
    2023: random.randint(50000, 99999),
    2024: random.randint(50000, 99999),
    2025: random.randint(50000, 99999)
}
